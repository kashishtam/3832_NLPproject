...
# Best model is stored in ./models as 'best_model.pth'
# example: model_to_load = 'models/best_model.pth'
model_to_load = input('Would you like to use the best checkpointed model? \n Y/N(Case Sensitive)\n')
...
df = df.drop(['rephrase', 'sarcasm', 'irony', 'satire', 'understatement', 'overstatement', 'rhetorical_question'], axis=1)
...
# Cleaning text resulted in a slight performance loss
